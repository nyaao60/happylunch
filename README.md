# <a href="https://haplunch.com//">ハピランチ</a>
  ...
  **サービス名：ハピランチ**<br>
  　　　**URL：<https://haplunch.com>**<br>
   ...
   「ハピランチ」とは、HAPPY（幸せ）とLUNCH（ランチ）を融合させた造語であり、社会人の皆様のランチタイムをより充実させたいという想いで作成したサービスです。<br>
  当サービスは、現在地や目的地から手頃で美味しい、健康的なランチメニューやお弁当を簡単に検索し、共有できるプラットフォームです。<br>
  他の飲食店情報提供サービスとは一線を画し、当サービスは、メニューそのものに焦点を当て、効率的なランチ選びを目指しました。<br>
